...
using MashComputerShop.MashShop.Views;
...
namespace MashComputerShop
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            UserTab.UserVM = ShoppingCartVM.UserVM;
        ...
        private void changeMainPageContext()
        {
            ...
            //}
            else if (settingsSelector.IsSelected)
            {
                mainContentFrame.Navigate(typeof(Help), ShoppingCartVM);
                changeTopbarTitle(settingsSelectorLabel.Text);
            }
        }
